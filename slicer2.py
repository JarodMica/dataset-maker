# from https://github.com/openvpi/audio-slicer/blob/main/slicer2.py
...
def main():
    ...
    parser.add_argument('--min_length', type=int, required=False, default=7000,
                        help='The minimum milliseconds required for each sliced audio clip')
    parser.add_argument('--min_interval', type=int, required=False, default=1000,
